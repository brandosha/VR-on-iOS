...
//
// implimentation of https://github.com/laanlabs/SCNTechniqueGlow
// created by laanlabs
//
...
constant float offset[] = {0.1}; //{ 0.0, 1.0, 2.0, 3.0, 4.0 };
constant float weight[] = {0.23}; //{ 0.2270270270, 0.1945945946, 0.1216216216, 0.0540540541, 0.0162162162 };
